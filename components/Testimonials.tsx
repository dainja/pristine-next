...
export const Testimonial: React.FC<{ review: Review }> = ({ review }) => {
  console.log(review);
  ...
  return (
    <div className="pb-16 mb-16 bg-tarawera lg:pb-0 lg:z-10 lg:relative">
      <div className="flex-shrink-0 lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8">
        <div className="relative lg:-mt-8 lg:mb-4">
          <div
            aria-hidden="true"
            className="absolute inset-x-0 top-0 h-1/2 bg-custom1 lg:hidden"
          />
          <div className="max-w-xs px-4 mx-auto sm:px-6 lg:p-0 lg:h-full">
            <div className="relative overflow-hidden shadow-xl aspect-w-8 sm:aspect-w-12 aspect-h-8 sm:aspect-h-14 lg:aspect-none">
              <Image
                objectFit="cover"
                layout="fill"
          ...
          <div className="max-w-md px-4 mx-auto sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
            <blockquote>
              <div>
                ...
                <p className="mt-6 text-xl font-medium text-white md:text-2xl">
                  {review.review.text}
                </p>
              </div>
              ...
              <div className="inline-flex items-center divide-x divide-gray-300">
                <div className="flex items-center flex-shrink-0 pr-5">
                  ...
                  <span className="ml-2 text-sm text-white ">
                    till {review.subject.employee.name}
                  </span>
                </div>
                <div className="flex-1 min-w-0 py-1 pl-5 text-sm text-gray-400 sm:py-3">
